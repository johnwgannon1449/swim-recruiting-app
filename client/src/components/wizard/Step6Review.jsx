...
export default function Step6Review() {
  ...
  return (
    <div>
      ...
      <p className="text-gray-500 mb-6">{t('wizard.step6.subtitle')}</p>

      <div className="flex flex-col lg:flex-row gap-6">
        {/* Main editor */}
        <div className="flex-1">
          <textarea
            className="input min-h-[480px] resize-y text-sm leading-relaxed font-mono"
            value={text}
        ...
        <div className="lg:w-56 flex-shrink-0">
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 sticky top-24">
            ...
            <button
              ...
              className="mt-4 w-full text-xs btn-secondary py-1.5"
            >
